...
function showNewUserOnScreen(user){
  console.log("in show new user on screen",user);
  ...
  // document.getElementById('category').options[document.getElementById('category').selectedIndex].text=""; 
    ...
    const childHTML = `<li id=${user._id} class="list-group-item"> ${user.amount} - ${user.Description}-${user.category}
                                          <button onclick=deleteUser('${user._id}') class="btn btn-danger btn-sm"> Delete Expense </button>
